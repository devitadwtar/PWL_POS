...
class UserController extends Controller
{
    ...
    {
        $request->validate([
            'username' => 'required|string|min:3|unique:m_user,username', // username harus diisi, berupa string, minimal 3 karakter, dan unik di tabel m_user
    ...
    { 
        $user = UserModel::with('level')->find($id); // ambil data user beserta level-nya
    ...
    public function destroy(string $id) 
    {
        ...
        try {
            ...
            // Jika terjadi error karena relasi di tabel lain
